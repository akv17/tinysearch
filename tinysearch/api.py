...
class API:
    """
    Публичный интерфейс для работы с приложением aka главная точка входа.
    Предоставляет возможность:
        1. Загрузить корпус по конфигу
        2. Загрузить движок по конфигу
        3. Создает движок по конфигу
        4. Индексировать движок по конфигу и сохранить результат
        5. Получить документ по айди
        6. Выполнить поиск с помощью загруженного движка.
    """
